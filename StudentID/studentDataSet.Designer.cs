...
namespace StudentID {
    ...
    public partial class studentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentInfoDataTable : global::System.Data.TypedTableBase<StudentInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentInfoRow AddStudentInfoRow(string StudentID, string StudentName, string Major) {
...
namespace StudentID.studentDataSetTableAdapters {
    ...
    public partial class StudentInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `StudentInfo` WHERE ((`ID` = ?) AND ((? = 1 AND `StudentID` IS NULL) " +
                "OR (`StudentID` = ?)) AND ((? = 1 AND `StudentName` IS NULL) OR (`StudentName` =" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `StudentInfo` SET `StudentID` = ?, `StudentName` = ?, `Major` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `StudentID` IS NULL) OR (`StudentID` = ?)) AND ((? = 1 AND `StudentName` IS NULL) OR (`StudentName` = ?)) AND ((? = 1 AND `Major` IS NULL) OR (`Major` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, StudentID, StudentName, Major FROM StudentInfo";
        ...
        public virtual int Delete(int Original_ID, string Original_StudentID, string Original_StudentName, string Original_Major) {
        ...
        public virtual int Update(string StudentID, string StudentName, string Major, int Original_ID, string Original_StudentID, string Original_StudentName, string Original_Major) {
            if ((StudentID == null)) {
